...
//Timer
var distance = 2*1000*60; // tTime in milliseconds
var x = setInterval(function() {
    ...
    document.getElementById("timer").textContent = hours +" hours "+minutes + "m " + seconds + "s " ;
...
function handleTimerEnd() {
    ...
    window.history.replaceState({}, document.title, redirectURL);
        ...
        var questions = [
            new Question("What is the capital of France?", [    // this question is Questions.questionText after spread operator the questions
            ...
            new Question("Which programming language is known as the 'language of the web'?", [
        ...
        function displayQuestion(question) {
            ...
            var questionElement = $('<div class="question"></div>').text(question.questionText);
            var answersElement = $('<form class="answers"></form>');

            question.answers.forEach(function (answer, index) {
                var answerElement = $('<label></label>').text(answer.text);
                var radioButton = $('<input type="radio" name="answer" value="' + answer.text + '">');
...
//Mark Section
    ...
    if (markedQuestions.length > 0) {
        ...
        markedQuestions.forEach(function (markedQuestion, index) {
            ...
            var questionLink = $('<a href="#" class="marked-question-link"></a>').text('Question number ' + Number(index + 1) + ' :' + markedQuestion.questionText);
            var deleteQuestionButton = $('<button class="deleteMarkedQuestion">Delete</button>');
        ...
        markedQuestionsContainer.append('<p id="marked" style="margin-left:10px;margin-top:10px;">' + ' ' + ' Marked Questions:</p>');
